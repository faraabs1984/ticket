...
@section('breadcrumb')
    ...
    <li class="breadcrumb-item">{{ __('Chats') }}</li>
@endsection
                                ...
                                <ul class="users">
                                    @foreach ($users as $user)
                                        <li class="user_chat" id="{{ $user->id }}">
                                            <div class="peroson">
                                                <img class="avatar-sm rounded-circle mr-3" style="width:40px;" src="{{asset(Storage::url('avatar.png'))}}" alt="{{$user->email}}">
                                                <div>
                                                    @if(!empty($user->name))                                                   
                        ...
                        <div class="chat-screen">
                            ...
                            <div class="chat-footer">
                                <div class="send-msg-box">
                                    <input type="text" class="form-control send_msg" placeholder="{{__('Type Message here ')}}" name="message"/><i class="ti ti-brand-telegram send_msg_btn"></i>
                                </div>
                            </div>
                        </div>
                    </div>
