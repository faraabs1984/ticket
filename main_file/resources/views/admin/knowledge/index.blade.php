...
@section('multiple-action-button')
    @can('create-knowledge')
        <div class="btn btn-sm btn-primary btn-icon float-end ms-2">
            <a href="{{ route('admin.knowledge.create') }}" class="" data-bs-toggle="tooltip"
                data-bs-placement="top" title="{{ __('Create Knowledge') }}"><i class="ti ti-plus text-white"></i></a>
        </div>
    @endcan

    @can('manage-knowledgecategory')
        <div class="btn btn-sm btn-primary btn-icon float-end">
            <a href="{{ route('admin.knowledgecategory') }}" class="" data-bs-toggle="tooltip"
                data-bs-placement="top" title="{{ __('Create Knowledge Category') }}"><i
