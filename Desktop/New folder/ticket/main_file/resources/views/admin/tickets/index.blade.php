...
@section('multiple-action-button')
    <div class="row justify-content-end">
        ...
        <div class="col-auto">
            @can('create-tickets')
                <div class="btn btn-sm btn-primary btn-icon m-1 float-end ms-2">
                    <a href="{{route('admin.tickets.create')}}" class="" data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Create Ticket')}}"><i class="ti ti-plus text-white"></i></a>
                </div>
            @endcan
            <div class="btn btn-sm btn-primary btn-icon m-1 ms-2">
                <a href="{{route('tickets.export')}}" class=" "data-bs-toggle="tooltip" data-bs-placement="top" title="{{__('Export Tickets CSV file')}}"><i class="ti ti-file-export text-white"></i></a>            
            </div>
        </div>
    </div>
@endsection
